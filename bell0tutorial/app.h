...
namespace core
{
	...
	private:
		...
		util::Expected<void> pauseApplication();
		util::Expected<void> resumeApplication(bool recreateGraphics = false, bool restartTimer = false);
	...
	protected:
		...
		mathematics::numberTheory::NumberTheory* numberTheory;	// the number theory component
	...
	public:
		...
		// get physics dt
		const double getPhysicsDeltaTime() const { return dt; };
		...
		mathematics::numberTheory::NumberTheory& getNumberTheoryComponent() const;
	};
}